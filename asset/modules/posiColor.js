...
export class posiColor {
    constructor(params) {
        ...
        this.setParams = function (params) {
            me.id = params.id ? params.id : 'posiColor';
            me.data = params.data ? params.data : false;
            me.pLib = params.pLib ? params.pLib : 'lib';
            me.pVal = params.pVal ? params.pVal : 'value';
            me.pFreq = params.pFreq ? params.pFreq : 'nb';
            ...
            me.interpolates = params.interpolates ? params.interpolates : false;
            me.frequency = params.frequency ? params.frequency : false;
