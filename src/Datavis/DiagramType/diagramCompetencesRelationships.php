<?php
namespace ChaoticumSeminario\Datavis\DiagramType;
...
class diagramCompetencesRelationships implements DiagramTypeInterface
{
    /**
    ...
    {
        return 'Diagramme des relations entre compétences'; // @translate
    }
