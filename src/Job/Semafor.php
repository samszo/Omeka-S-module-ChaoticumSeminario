...
class Semafor extends AbstractJob
{
    /**
    ...
    public function perform(): void
    {
        ...
        $semaforCredentials = $services->get('ViewHelperManager')->get('semaforCredentials');
        if (!$semaforCredentials()) {
            $logger->err(
                'Semafor credentials are not set.' // @translate
            );
            return;
        }
        ...
        $semafor = $services->get('ViewHelperManager')->get('semafor');
